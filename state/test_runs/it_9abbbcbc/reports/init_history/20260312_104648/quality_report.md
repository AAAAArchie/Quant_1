...
| --- | --- | --- | --- | --- |
| ods | 2024 | `state\test_runs\it_9abbbcbc\data\1_ods_raw\trade_cal\year=2024` | 1 | 2 |
| ods | 2025 | `state\test_runs\it_9abbbcbc\data\1_ods_raw\trade_cal\year=2025` | 1 | 4 |
| dwd | 2024 | `state\test_runs\it_9abbbcbc\data\2_dwd_detail\trade_cal\year=2024` | 1 | 2 |
| dwd | 2025 | `state\test_runs\it_9abbbcbc\data\2_dwd_detail\trade_cal\year=2025` | 1 | 4 |
...
| Layer | Year | Path | Files | Rows |
| --- | --- | --- | --- | --- |
| ods | 1991 | `state\test_runs\it_9abbbcbc\data\1_ods_raw\stock_basic\year=1991` | 1 | 1 |
| dwd | 1991 | `state\test_runs\it_9abbbcbc\data\2_dwd_detail\stock_basic\year=1991` | 1 | 1 |
